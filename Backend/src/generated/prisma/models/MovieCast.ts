...
// @ts-nocheck 
/*
 * This file exports the `MovieCast` model and its related types.
 *
...
export type GetMovieCastAggregateType<T extends MovieCastAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMovieCast[P]>
    : Prisma.GetScalarType<T[P], AggregateMovieCast[P]>
}
...
export type GetMovieCastGroupByPayload<T extends MovieCastGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MovieCastGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MovieCastGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MovieCastGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MovieCastGroupByOutputType[P]>
      }
    >
  >
...
export type MovieCastCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface MovieCastDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends MovieCastCountArgs>(
    args?: Prisma.Subset<T, MovieCastCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MovieCastCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, MovieCastGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMovieCastGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
