...
// @ts-nocheck 
/*
 * This file exports the `ShowtimeTicketType` model and its related types.
 *
...
export type GetShowtimeTicketTypeAggregateType<T extends ShowtimeTicketTypeAggregateArgs> = {
      [P in keyof T & keyof AggregateShowtimeTicketType]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateShowtimeTicketType[P]>
    : Prisma.GetScalarType<T[P], AggregateShowtimeTicketType[P]>
}
...
export type GetShowtimeTicketTypeGroupByPayload<T extends ShowtimeTicketTypeGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ShowtimeTicketTypeGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ShowtimeTicketTypeGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ShowtimeTicketTypeGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ShowtimeTicketTypeGroupByOutputType[P]>
      }
    >
  >
...
export type ShowtimeTicketTypeCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ShowtimeTicketTypeFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ShowtimeTicketTypeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ShowtimeTicketType'], meta: { name: 'ShowtimeTicketType' } }
  /**
   ...
   * })
  **/
  count<T extends ShowtimeTicketTypeCountArgs>(
    args?: Prisma.Subset<T, ShowtimeTicketTypeCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ShowtimeTicketTypeCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ShowtimeTicketTypeGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ShowtimeTicketTypeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetShowtimeTicketTypeGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
