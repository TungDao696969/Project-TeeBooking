...
export type GetUserAddressAggregateType<T extends UserAddressAggregateArgs> = {
    [P in keyof T & keyof AggregateUserAddress]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateUserAddress[P]> : Prisma.GetScalarType<T[P], AggregateUserAddress[P]>;
};
...
export type GetUserAddressGroupByPayload<T extends UserAddressGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<UserAddressGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof UserAddressGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], UserAddressGroupByOutputType[P]> : Prisma.GetScalarType<T[P], UserAddressGroupByOutputType[P]>;
}>>;
export type UserAddressWhereInput = {
    ...
    addressDetail?: Prisma.StringFilter<"UserAddress"> | string;
...
export type UserAddressScalarWhereWithAggregatesInput = {
    ...
    addressDetail?: Prisma.StringWithAggregatesFilter<"UserAddress"> | string;
...
export type UserAddressOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "province" | "district" | "ward" | "addressDetail" | "isDefault" | "createdAt", ExtArgs["result"]["userAddress"]>;
...
export type UserAddressCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<UserAddressFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface UserAddressDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends UserAddressCountArgs>(args?: Prisma.Subset<T, UserAddressCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], UserAddressCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends UserAddressGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, UserAddressGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUserAddressGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface UserAddressFieldRefs {
    ...
    readonly addressDetail: Prisma.FieldRef<"UserAddress", 'String'>;
