...
export declare const createVnpayPaymentController: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
...
export declare const createMoMoController: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
