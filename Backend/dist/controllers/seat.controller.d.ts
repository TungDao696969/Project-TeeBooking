...
export declare const updateSeatType: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const getAllSeats: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
...
export declare const getTrashSeats: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const restoreSeat: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
