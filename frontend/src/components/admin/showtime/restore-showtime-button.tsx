...
import { useRestoreShowtime } from "@/hooks/admin/showtime/use-restore-showtime";

interface Props {
  id: string;
}

export default function RestoreShowtimeButton({ id }: Props) {
  const { mutate, isPending } = useRestoreShowtime();
        ...
        <div className="px-6 pt-5 pb-6">
          <AlertDialogHeader className="mb-4">
            ...
            <AlertDialogDescription className="text-neutral-500 text-sm leading-relaxed pl-12">
              Suất chiếu này sẽ được khôi phục và hiển thị lại trong danh sách
